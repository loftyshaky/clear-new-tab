...
## Особенности версии для Firefox — кнопка «Домой»

Функция кнопки «Домой» **недоступна** в версии Clear New Tab для Firefox из-за ограничения платформы — Firefox не позволяет расширениям программно открывать стандартную страницу новой вкладки браузера.
