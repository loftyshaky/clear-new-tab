...
if (what_browser === 'firefox') {
    (() => {
        try {
            ...
            } else if (installing_theme.con.install_src === 'theme_beta') {
                const ff_install_btn_w = x.create('div', 'ff_install_btn_w');
                x.after(s('.btn-apply'), ff_install_btn_w);

                ReactDOM.render(
                    <Ff_install_btn theme_beta_theme_id={get_theme_beta_id.get_theme_beta_id()} />,
                    ff_install_btn_w,
                );
            }
