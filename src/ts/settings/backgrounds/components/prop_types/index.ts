export * from 'settings/backgrounds/components/prop_types/actions';
export * from 'settings/backgrounds/components/prop_types/background';
export * from 'settings/backgrounds/components/prop_types/drop_zone';
...
export * from 'settings/backgrounds/components/prop_types/thumbnail_w';
