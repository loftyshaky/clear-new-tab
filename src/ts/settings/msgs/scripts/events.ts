    ...
    (msg: t.Any): t.Any =>
        err(() => {
            ...
            if (['load_settings', 'update_settings_settings'].includes(msg_str)) {
                return d_data.Settings.set_from_storage().catch((error_obj: i_error.ErrorObj) =>
                    show_err_ribbon(error_obj, 'cnt_1492'),
                );
            }
            ...
            if (msg_str === 'set_current_background_i') {
                return d_data.Settings.set_from_storage()
                    ...
                    .then(() => true)
                    .catch((error_obj: i_error.ErrorObj) => show_err_ribbon(error_obj, 'cnt_1493'));
            }
            ...
            if (msg_str === 'set_current_background_id_to_id_of_first_background') {
                return d_backgrounds.CurrentBackground.set_current_background_id_to_id_of_first_background()
                    .then(() => true)
                    .catch((error_obj: i_error.ErrorObj) => show_err_ribbon(error_obj, 'cnt_1494'));
            }
            ...
            if (msg_str === 'delete_theme_backgrounds') {
                return d_browser_theme.Backgrounds.delete_theme_backgrounds({
                    ...
                    .then(() => true)
                    .catch((error_obj: i_error.ErrorObj) => show_err_ribbon(error_obj, 'cnt_1495'));
            }
            ...
            if (msg_str === 'forbid_animation') {
                void d_backgrounds.BackgroundAnimation.forbid_animation();
            ...
            if (msg_str === 'upload_success') {
                return d_backgrounds.SideEffects.upload_success()
                    .then(() => true)
                    .catch((error_obj: i_error.ErrorObj) => show_err_ribbon(error_obj, 'cnt_1496'));
            }
            ...
            if (msg_str === 'upload_error') {
                return d_backgrounds.SideEffects.upload_error({
                    ...
                    .then(() => true)
                    .catch((error_obj: i_error.ErrorObj) => show_err_ribbon(error_obj, 'cnt_1497'));
            }

            if (msg_str === 'update_tasks') {
                return d_scheduler.Tasks.set_tasks()
                    .then(() => true)
                    .catch((error_obj: i_error.ErrorObj) => show_err_ribbon(error_obj, 'cnt_1498'));
            }
