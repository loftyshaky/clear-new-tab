...
export class Crx {
    ...
    public get = ({ theme_id }: { theme_id: string }): Promise<ArrayBuffer> =>
        err_async(async () => {
            const crx_url: string = `https://clients2.google.com/service/update2/crx?response=redirect&prodversion=9999.0.9999.0&acceptformat=crx2,crx3&x=id%3D${theme_id}%26uc`;
