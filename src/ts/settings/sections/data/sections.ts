                            ...
                            text_btns: [
                                {
                                    ...
                                    visibility_cond:
                                        d_sections.TextBtns.decide_paste_background_btn_visibility,
                ...
                new o_inputs.Section({
                    ...
                    inputs: [
                        ...
                        new o_inputs.Text({
                            ...
                            event_callback: d_sections.Val.current_background_id_change_debounce,
                            warn_state_checker: d_sections.Validation.validate_input,
                        }),
                        new o_inputs.Checkbox({
                ...
                ...d_sections_loftyshaky.Sections.make_shared_sections({
                    ...
                    restore_inputs: [
                        new o_inputs.Btn({
                            ...
                            event_callback:
                                d_backgrounds.BackgroundDeletion.delete_all_backgrounds_confirm,
                        }),
                        new o_inputs.Btn({
