        ...
        err_async(async () => {
            const handle_missed_tasks = (): Promise<void> =>
                err_async(async () => {
                    const alarm_data_2: i_db.AlarmDataItem[] =
                        await s_db.Manipulation.get_alarm_data();
                    ...
                    await s_db.Manipulation.replace_alarm_data({
            ...
            const remove_expired_tasks = (): Promise<void> =>
                err_async(async () => {
                    ...
                    await s_db.Manipulation.delete_tasks({ ids: expired_task_ids });
...
export const Scheduler = Class.get_instance();
